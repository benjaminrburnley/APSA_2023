...
clean = data %>% 
  dplyr::select(
    LocationLatitude, LocationLongitude, Q332:Q337,Q362_2:Q362_5,Q370:Q375, Q2_1:Q2_4, `1_Q408_1`:`1_Q411_1`,`2_Q408_1`:`2_Q411_1`,`3_Q408_1`:`3_Q411_1`,`4_Q408_1`:`4_Q411_1`, `5_Q408_1`:`5_Q411_1`,Q1...137:Q14,Q383_1:Q383_8, Q1...169,Q423,Q448:Q457
  ) %>% 
  rename(
...
survey = clean %>% 
  mutate(mist_1 = if_else(MIST1 == "Fake News", 1, 0),
         ...
         mist_score = mist_1 + mist_2 + mist_3 + mist_4 + mist_5 + mist_6 + mist_7 + mist_8)
